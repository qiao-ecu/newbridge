...
/**
 * 使用Map数据结构来代替直接的单向链表。Change by MENGRAN at 2016-02-21
 * 添加联系人信息
 *
...
Core.prototype._addContacts = function (info) {
    ...
    _contacts.set(node.id, node.data);
};
